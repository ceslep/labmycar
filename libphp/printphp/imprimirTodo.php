  ...
  and  fecha='$fecha'";
    ...
    if ($result = $mysqli->query($sql)) {
        ...
        ";
                ...
                // Para hemogramaRayto, obtener constantes de referencia desde procedimientos.constante2
                $referencias_hemo = [];
                $referencias_lipidico = []; // Initialize for perfilLipidico
                if ($tablaex === 'hemogramaRayto') {
                    ...
                    if ($res_ref && $res_ref->num_rows > 0) {
                        ...
                        $raw_json = trim($row_ref['constant']);
                ...
                $titulo_analisis = ($tablaex === 'hemogramaRayto') ? 'Cuadro Hemático completo' : $info;
                $html .= "<table>
            <caption><h4>Resultados del Análisis $titulo_analisis</h4></caption>
            <thead >
                <tr>
                    <th>
                      Dato
    ...
    ";
                ...
                foreach ($datos as $key => $value) {
                    ...
                    if (strpos(strtolower($tablaex), "hemo") !== false || strpos(strtolower($tablaex), "hema") !== false) {
                    ...
                    if ($tiene_referencias) {
                        ...
                        $html .= "\t\t\t\t\t\t\t<td class='text-start'>" . htmlspecialchars($referencia) . "</td>\n";
                    }
                    $html .= "\t\t\t\t\t</tr>\n";
                }
                $html .= "\t</tbody>\n";
